      ...
      [:div {:class "pt-12 md:pt-20"} #_[:comment " Section header "]
       [:div {:class "max-w-3xl mx-auto text-center pb-12 md:pb-16"}
        ...
        [:p {:class "text-xl text-gray-600"}
         "Our job is to find a path from a business need to a technical solution that is simple, highly effective, and delivered on-time"]]
       #_[:comment " Top image "]
       ...
       #_[:div {:class "md:grid md:grid-cols-12 md:gap-6", :x-data "{ tab: '1' }"}
        #_[:comment " Content "]
        [:div
         {:class
